...
<section class="nav " dir="rtl">
    ...
    <div class="hero_of_about" style="background-image: linear-gradient(90deg, rgb(43
        ...
        <div class="text-center align-bottom hero-items">
            <h1 class="hero_title">{{ $album->name }}</h1>
            <h5 class="hero_sub_title">الرئيسية / ألبوم الصور / صور        </h5>
...
<section class="postdetails  pt-5">
    <div class="container">
        <div class="row">
            @forelse ($photos as $photo)
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="img_of_post_details hvr-grow">
                        <a href="{{ asset('storage/' . $photo->image) }}" data-toggle="lightbox" data-gallery="gallery" >
