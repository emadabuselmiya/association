...
<section class="nav " dir="rtl">
                      ...
                      d-lg-block">
                                ...
                                <li>
                                    <button class="btn btn-outline-more hvr-bounce-to-top"><a
                                            href="{{ route('site.contact-us') }}" class="nav-link" style="color: white">كيف
                                            تدعمنا</a>
                                    </button>
                                </li>
    ...
    <div class="hero_of_about" style="background-image: linear-gradient(90deg, rgb(43
        ...
        <div class="text-center align-bottom hero-items">
            <h1 class="hero_title">{{ $page->title }} </h1>
            <h5 class="hero_sub_title">الرئيسية / {{$page->menu->name}} </h5>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-6">
                <div class="img_of_post" data-aos="fade-up">
                    <img src="{{ asset('storage/' . $page->main_image) }}" width="100%"  class="img-fluid" alt="">
                </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-right">
                <p class="desc_of_the_post" data-aos="fade-down">{{ strip_tags($page->description) }}
                </p>
            </div>
...
<section class="albums_of_photo">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center pt-5 p-5">صور اخرى</h2>
            </div>
            <div class="row">
            @foreach($page->images as $image)
                <div class="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <div class="card" style="width: 100%;">
                        <div class="image-of-news"><img src="{{ asset('storage/' . $image->image) }}"
