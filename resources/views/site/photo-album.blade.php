                                ...
                                @endforeach
                                    <li>
                                        <button class="btn btn-outline-more hvr-bounce-to-top"><a
                                                href="{{ route('site.contact-us') }}" class="nav-link" style="color: white">كيف تدعمنا</a>
                                        </button>
                                    </li>
        ...
        <div class="row">
            ...
            @forelse ($albums as $album)
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <a href="{{ route('site.photo-album.photos', $album->id) }}">
                        <div class="card" style="width: 100%;">
                            <div class="image-of-news">
                                <img src="{{asset('storage/' . $album->image)}}" class="card-img-top hvr-grow"
                                     alt="{{ $album->name }}">
                            </div>

                            <span class="date-of-card"> {{$album->photoAlbumImages()->count()}} صورة</span>
                            <div class="card-body">
                                <h3 class="card-text card-paragraph text-center">{{ $album->name }}</h3>
                            </div>
                        </div>
                    </a>
                </div>
