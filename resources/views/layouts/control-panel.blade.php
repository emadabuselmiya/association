...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/c-panel/vendor/jqvmap/css/jqvmap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/c-panel/vendor/chartist/css/chartist.min.css') }}">
    <link rel="stylesheet"
          href="{{ asset('assets/c-panel/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/c-panel/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/c-panel/css/skin-2.css') }}">
    @yield('css', ' ')
...
<!-- Required vendors -->
<script src="{{ asset('assets/c-panel/vendor/global/global.min.js') }}"></script>
<script src="{{ asset('assets/c-panel/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}"></script>
<script src="{{ asset('assets/c-panel/js/custom.min.js') }}"></script>
<script src="{{ asset('assets/c-panel/js/dlabnav-init.js') }}"></script>

<!-- Chart ChartJS plugin files -->
<script src="{{ asset('assets/c-panel/vendor/chart.js/Chart.bundle.min.js') }}"></script>

<!-- Chart piety plugin files -->
<script src="{{ asset('assets/c-panel/vendor/peity/jquery.peity.min.js') }}"></script>

<!-- Chart sparkline plugin files -->
<script src="{{ asset('assets/c-panel/vendor/jquery-sparkline/jquery.sparkline.min.js') }}"></script>

<!-- Demo scripts -->
<script src="{{ asset('assets/c-panel/js/dashboard/dashboard-3.js') }}"></script>

<!-- Svganimation scripts -->
<script src="{{ asset('assets/c-panel/vendor/svganimation/vivus.min.js') }}"></script>
<script src="{{ asset('assets/c-panel/vendor/svganimation/svg.animation.js') }}"></script>
<script src="{{ asset('assets/c-panel/js/styleSwitcher.js') }}"></script>
