                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type='file' onchange="loadFile_image1(favicon_image)"
                                               name="favicon_image" id="favicon_image"
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="email" class="form-label">{{ __('Website Address') }}</label>
                                        <input type="text" id="address" name="address"
                                               value="{{ old('address',$website->address) }}"
                                               class="form-control" required>
                                    </div>
                                </div>
                                {{-- end website address --}}
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="url" id="behance" name="behance"
                                               value="{{ old('behance',($website->behance ?? ' ')) }}"
                                               class="form-control">
                                    </div>
                                </div>
                                {{-- end website behance --}}
