        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{ __('All Vedio Albums') }}</h2>
            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    <div class="card-datatable table-responsive pt-0">
                        <x-alert />
                        <table class="vedio-album-list-table table">
        ...
        @foreach ($albums as $album)
            ...
            <div class="modal fade" id="modals-delete-{{ $album->id }}">
                <div class="modal-dialog">
                    <form class="add-new-user modal-content pt-0" action="{{route('vedio-album.destroy',$album->id)}}"
                        method="POST">
                        @csrf
                        @method('DELETE')
