        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{ __('Edit Vedio Album') }}</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <section class="app-user-edit">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('vedio-album.update', $album->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group fallback w-100">
                                        ...
                                        <input type="text" id="link" name="link" value="{{ old('link', $album->link) }}"
