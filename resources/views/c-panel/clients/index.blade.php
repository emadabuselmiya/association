...
@section('content')
    ...
    @foreach ($clients as $client)
        <!-- Modal to add new user starts-->
            <div class="modal fade" id="modals-delete-{{ $client->id }}">
                <div class="modal-dialog">
                    <form class="add-new-user modal-content pt-0" action="{{route('clients.destroy',$client->id)}}"
                          method="POST">
                        @csrf
                        @method('DELETE')
