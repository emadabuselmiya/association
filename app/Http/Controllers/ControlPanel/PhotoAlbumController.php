...
class PhotoAlbumController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('c-panel.multiMedia.photoAlbum.index',[
            'albums' => $albums,
        ]);
    }
    ...
    {
        return view('c-panel.multiMedia.photoAlbum.create');
    }
    ...
    {
        return view('c-panel.multiMedia.photoAlbum.show',[
            'album' => $photo_album,
        ]);
    }
    ...
    {
        return view('c-panel.multiMedia.photoAlbum.edit',[
            'album' => $photo_album,
        ]);
    }
